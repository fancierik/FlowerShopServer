...
export class ClientpageComponent implements OnInit {
  ...
  Thing1Btn() {
    ...
    this.namee+= nam
    this.dataSource.push({name: "Авторский букет Нежный" , price: 2730*num})
  ...
  Thing2Btn() {
    ...
    this.namee+= nam
    this.dataSource.push({name: "Пудровые розы", price: 3000*num})
    this.table.renderRows();
  }
  ...
  Thing3Btn() {
    ...
    var nam = "- Ромашки "
    this.namee+= nam
    this.dataSource.push({name: "Ромашки", price: 2000*num})
    this.table.renderRows();
  }
  ...
  Thing4Btn() {
    ...
    var nam="- Эвкалипт "
    this.namee+= nam
    this.dataSource.push({name: "Эвкалипт", price: 200*num})
    this.table.renderRows();
  }
  ...
  Thing5Btn() {
    ...
    this.namee+= nam
    this.dataSource.push({name: "Букет с гортензией", price: 3320*num})
    this.table.renderRows();
  }
  ...
  Thing6Btn() {
    ...
    this.namee+=  nam
    this.dataSource.push({name: "Авторский букет пудровый", price: 4000*num})
    this.table.renderRows();
  }
  Thing9Btn() {
    var num=1
    ...
    var nam="- Тюльпаны "
    this.namee+=  nam
    this.dataSource.push({name: "Тюльпаны", price: 1000*num})
    this.table.renderRows();
  }
  Thing7Btn() {
    var num=1
    ...
    var nam="- Солнечный "
    this.namee+=  nam
    this.dataSource.push({name: "Солнечный", price: 3500*num})
    this.table.renderRows();
  }
  Thing8Btn() {
    var num=1
    ...
    var nam="- Облако "
    this.namee+=  nam
    this.dataSource.push({name: "Облако", price: 2260*num})
    this.table.renderRows();
  }
